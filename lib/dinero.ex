defmodule Dinero do
  ...
  **Note:** `Dinero` uses coins value for calculations. So when you
  ...
  @doc ~S"""
  Mutliplies a `Dinero` by a value
  ...
  @spec multiply_round(t, float) :: t
  @doc ~S"""
  Mutliplies a `Dinero` by a float value and rounds the result
  ## Example
    iex> d = Dinero.new(100, :USD)
    %Dinero{amount: 10000, currency: :USD}
    iex> Dinero.multiply_round(d, 1.005)
  ...
  @spec multiply_trunc(t, float) :: t
  @doc ~S"""
  Mutliplies a `Dinero` by a float value and truncates the result
  ## Example
    iex> d = Dinero.new(100, :USD)
    %Dinero{amount: 10000, currency: :USD}
    iex(17)> Dinero.multiply_trunc(d, 1.005)
